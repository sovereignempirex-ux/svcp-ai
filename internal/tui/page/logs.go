...
import (
	...
	"github.com/svpc-ai/svpc/internal/tui/components/logs"
...
func NewLogsPage() LogPage {
	return &logsPage{
		table:   layout.NewContainer(logs.NewLogsTable(), layout.WithRoundedBorder(), layout.WithBorderAll()),
		details: layout.NewContainer(logs.NewLogsDetails(), layout.WithRoundedBorder(), layout.WithBorderAll()),
	}
}
