...
var rootCmd = &cobra.Command{
	Use:   "svpc",
	Short: "SVPC AI - Terminal-based AI assistant for software development",
	Long: `SVPC AI is a powerful terminal-based AI assistant that helps with software development tasks.
